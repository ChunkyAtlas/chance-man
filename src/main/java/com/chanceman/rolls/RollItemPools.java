...
public class RollItemPools
{
    private static final Set<Integer> TOOL_ITEMS = Set.of(
            ...
            ItemID.OIL_LANTERN_UNLIT,
            ItemID.BULLSEYE_LANTERN_LENS,
            ItemID.SECATEURS,
            ItemID.RAKE,
            ItemID.DIBBER,
            ItemID.PLANTPOT_EMPTY,
            ItemID.PLANTPOT_COMPOST,
            ItemID.TIARA_MOULD,
            ItemID.POH_SAW,
            ItemID.XBOWS_SILVER_BOLT_MOULD,
            ItemID.HUNTING_OJIBWAY_BIRD_SNARE,
            ItemID.HUNTING_BOX_TRAP,
            ItemID.HUNTING_BUTTERFLY_NET,
            ItemID.BUTTERFLY_JAR,
            ItemID.MAGIC_IMP_BOX,
            ItemID.HUNTING_TEASING_STICK,
            ItemID.HUNTING_SNARE,
            ItemID.NOOSE_WAND,
            ItemID.JEWL_BRACELET_MOULD,
    ...
    private static final Set<Integer> QUEST_ITEMS = Set.of(
            ...
            ItemID.RAW_CHOMPY,
            ItemID.SILVER_SICKLE,
            ItemID.MORTMYREMUSHROOM,
            ItemID.MORTMYREBUDDINGSTEM,
            ItemID.MORTMYREPEAR,
            ...
            ItemID.LIMESTONEBRICK,
            ItemID.FLAMTAER_HAMMER,
            ItemID.VIKING_TANKARD_FULL,
            ItemID.MM_MONKEY_NUTS,
            ItemID.SLAYER_MIRROR_SHIELD,
            ItemID.SLAYER_BAG_OF_SALT,
            ItemID.SLAYER_FACEMASK,
            ItemID.FAVOUR_AIRTIGHT_POT,
            ItemID.POTLID,
            ItemID.CUP_HOT_WATER,
            ItemID.BULLSEYE_LANTERN_LENS,
            ItemID.BULLSEYE_LANTERN_UNLIT,
            ItemID.FEUD_KARIDIAN_TURBAN,
            ItemID.FEUD_KARIDIAN_FAKEBEARD,
            ItemID.FD_CRUSHED_GARLIC,
            ItemID.ICS_LITTLE_LINEN,
            ItemID.ICS_LITTLE_SAP_BUCKET,
            ItemID.MISTRUNE,
            ItemID.MUDRUNE,
            ItemID.LAVARUNE,
            ItemID.ZOGRE_BOW,
            ...
            ItemID.POTATO_BAKED,
            ItemID.DRAGON_AXE,
            ItemID.AGRITH_DESERT_SHIRT_DYED,
            ItemID.AGRITH_DESERT_ROBE_DYED,
            ItemID.WEREWOLVE_FUR,
            ItemID.BOWL_SWEETCORN,
            ItemID.SLAYER_BOOTS,
            ItemID.SPIT_IRON,
            ItemID.CHICKENQUEST_POT_CORNFLOUR,
            ItemID.BLANKRUNE_HIGH,
            ItemID.POH_TABLET_VARROCKTELEPORT,
            ItemID.POH_TABLET_ENCHANTEMERALD,
            ItemID.POH_FLATPACK_BEERBARREL3,
            ItemID.POH_FLATPACK_BEERBARREL4,
            ItemID.PLANK_OAK,
            ItemID.PLANK_MAHOGANY,
            ItemID.CLOTH,
            ItemID.POH_CLOCKWORK_MECHANISM,
            ItemID.POH_SAW,
            ItemID.ASTRALRUNE,
            ItemID.XBOWS_GRAPPLE_TIP_BOLT_MITHRIL,
            ItemID.XBOWS_GRAPPLE_TIP_BOLT_MITHRIL_ROPE,
            ItemID.HUNTING_BOX_TRAP,
            ItemID.ANMA_P_BUTTONS,
            ItemID.ARCTIC_PINE_SPLIT,
            ItemID.YAK_HIDE_ARMOUR_BODY,
            ItemID.YAK_HIDE_ARMOUR_GREAVES,
            ItemID.FREMMENIK_ROUND_SHIELD,
            ItemID.BRAIN_INV_WOODEN_CAT,
            ItemID.BRUT_ROE,
